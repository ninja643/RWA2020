...
//		final TicketEntity ticketEntity = resolveTicket(ticketId);
//		
//		return findMessage(messageId, Collections.emptyList()/*ticketEntity.getMessages()*/);
//	}
//
//	@Override
...
//		final TicketEntity ticketEntity = resolveTicket(ticketId);
//		
//		final List<MessageEntity> messages = Collections.emptyList();//ticketEntity.getMessages();
//		
